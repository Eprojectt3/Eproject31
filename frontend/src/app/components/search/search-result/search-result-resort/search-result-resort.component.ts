...
@Component({
  selector: 'app-search-result-resort',
  templateUrl: './search-result-resort.component.html',
  styleUrls: ['./search-result-resort.component.scss'],
})
export class SearchResultResortComponent {
  hotels!: any[];
