...
namespace backend.Migrations
{
    ...
    public partial class lastfix : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        Transportation = table.Column<string>(
                            type: "nvarchar(max)",
                            nullable: false
                        ),
                        Departure_Date = table.Column<string>(
                            type: "nvarchar(max)",
                            nullable: false
                        ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        Departure_location = table.Column<string>(
                            type: "nvarchar(max)",
                            nullable: false
                        ),
                        CreateBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(name: "IX_Slugs_RoleId", table: "Slugs", column: "RoleId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "ForgotPasswordRequests");

            migrationBuilder.DropTable(name: "Information");

            migrationBuilder.DropTable(name: "Itinerarie");

            migrationBuilder.DropTable(name: "OrderDetail");

            migrationBuilder.DropTable(name: "Service");

            migrationBuilder.DropTable(name: "Slugs");

            migrationBuilder.DropTable(name: "UserRefreshTokens");

            migrationBuilder.DropTable(name: "Hotels");

            migrationBuilder.DropTable(name: "Resorts");

            migrationBuilder.DropTable(name: "Restaurant");
            ...
            migrationBuilder.DropTable(name: "TourDetail");
            ...
            migrationBuilder.DropTable(name: "Transportation");
        }
    }
}
