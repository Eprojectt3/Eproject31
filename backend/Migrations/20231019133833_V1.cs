        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Place_Type_ID = table.Column<int>(type: "int", nullable: false),
                    CreateBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_Places_PlaceTypes_Place_Type_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Itinerarie_PlaceTypes_Place_Type_ID",
                        column: x => x.Place_Type_ID,
                        principalTable: "PlaceTypes",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Itinerarie_Places_PlaceID",
                        column: x => x.PlaceID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Itinerarie_Place_Type_ID",
                table: "Itinerarie",
                column: "Place_Type_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Itinerarie_PlaceID",
                table: "Itinerarie",
                column: "PlaceID");
